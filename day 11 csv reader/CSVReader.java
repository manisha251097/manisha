...
public class CSVReader {
    ...
    public String[] getRow(int rowNumber) {
        // TODO
        // Your code goes here....
        if(rowNumber > 0 && rowNumber <= rowCount() && dataFrame.length > rowNumber && dataFrame.length > 0) {
    ...
    public String[] getRows(int fromIndex, int toIndex) {
        ...
        if(dataFrame.length > 0 && (fromIndex > 0 && toIndex > 0) && toIndex > fromIndex && (toIndex <= rowCount() && fromIndex < rowCount())) {
    ...
    public String[] getColumnValues(int index) {
         // TODO
        // Your code goes here.... 
        if(index > 0 && index < dataFrame.length && dataFrame.length > 0){
